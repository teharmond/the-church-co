...
export default function FundSettingsPage() {
  ...
  return (
    <div className="mt-6 w-full space-y-6 p-5">
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Fund Settings</SettingsTitle>
          <SettingsDescription>
            Configure your fund details and visibility.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow larger isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Fund Name</SettingsRowTitle>
              <SettingsRowDescription>
                The display name for this fund.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="Fund Name" defaultValue="General Fund" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                The URL slug for this fund.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="URL Slug" defaultValue="general-fund" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Control whether this fund is visible on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Who can view this fund on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Schedule when this fund becomes available.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Select
            ...
            <>
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this fund becomes available.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
              ...
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this fund becomes unavailable.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
      ...
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Fund Actions</SettingsTitle>
          <SettingsDescription>
            Manage this fund with quick actions.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Duplicate Fund</SettingsRowTitle>
              <SettingsRowDescription>
                Create a copy of this fund with all its settings.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
          ...
          <SettingsRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Delete Fund</SettingsRowTitle>
              <SettingsRowDescription>
                Permanently remove this fund. This action cannot be undone.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
