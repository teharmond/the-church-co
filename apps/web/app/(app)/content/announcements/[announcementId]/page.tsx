...
export default function AnnouncementSettingsPage() {
  ...
  return (
    <div className="mt-6 w-full space-y-6 p-5">
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Announcement Settings</SettingsTitle>
          <SettingsDescription>
            Configure your announcement details and visibility.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow larger isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Announcement Title</SettingsRowTitle>
              <SettingsRowDescription>
                The display title for this announcement.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="Announcement Title" defaultValue="Sunday Service Change" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                The URL slug for this announcement.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="URL Slug" defaultValue="sunday-service-change" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Control whether this announcement is visible on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Who can view this announcement on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Schedule when this announcement becomes available.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Select
            ...
            <>
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this announcement becomes available.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
              ...
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this announcement becomes unavailable.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
      ...
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Announcement Actions</SettingsTitle>
          <SettingsDescription>
            Manage this announcement with quick actions.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Duplicate Announcement</SettingsRowTitle>
              <SettingsRowDescription>
                Create a copy of this announcement with all its settings.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
          ...
          <SettingsRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Delete Announcement</SettingsRowTitle>
              <SettingsRowDescription>
                Permanently remove this announcement. This action cannot be undone.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
