...
export default function FormSettingsPage() {
  ...
  return (
    <div className="mt-6 w-full space-y-6 p-5">
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Form Settings</SettingsTitle>
          <SettingsDescription>
            Configure your form details and visibility.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow larger isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Form Name</SettingsRowTitle>
              <SettingsRowDescription>
                The display name for this form.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="Form Name" defaultValue="Contact Form" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                The URL slug for this form.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="URL Slug" defaultValue="contact-form" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Control whether this form is visible on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Who can view this form on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Schedule when this form becomes available.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Select
            ...
            <>
              ...
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this form becomes unavailable.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
      ...
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Form Actions</SettingsTitle>
          <SettingsDescription>
            Manage this form with quick actions.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Duplicate Form</SettingsRowTitle>
              <SettingsRowDescription>
                Create a copy of this form with all its settings.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
          ...
          <SettingsRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Delete Form</SettingsRowTitle>
              <SettingsRowDescription>
                Permanently remove this form. This action cannot be undone.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
