...
export default function ContributorSettingsPage() {
  ...
  return (
    <div className="mt-6 w-full space-y-6 p-5">
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Contributor Settings</SettingsTitle>
          <SettingsDescription>
            Configure your contributor details and visibility.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow larger isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Contributor Name</SettingsRowTitle>
              <SettingsRowDescription>
                The display name for this contributor.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="Contributor Name" defaultValue="John Smith" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                The URL slug for this contributor.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Input placeholder="URL Slug" defaultValue="john-smith" />
            </SettingsRowAction>
          </SettingsRow>
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Control whether this contributor is visible on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Who can view this contributor on your website.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
          ...
          <SettingsRow larger>
            <SettingsRowDetails>
              ...
              <SettingsRowDescription>
                Schedule when this contributor becomes available.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction larger>
              <Select
            ...
            <>
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this contributor becomes available.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
              ...
              <SettingsRow larger>
                <SettingsRowDetails>
                  ...
                  <SettingsRowDescription>
                    When this contributor becomes unavailable.
                  </SettingsRowDescription>
                </SettingsRowDetails>
                <SettingsRowAction larger>
                  <Popover>
      ...
      <SettingsSection>
        <SettingsHeader>
          <SettingsTitle>Contributor Actions</SettingsTitle>
          <SettingsDescription>
            Manage this contributor with quick actions.
          </SettingsDescription>
        </SettingsHeader>
        <SettingsContent>
          <SettingsRow isFirstRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Duplicate Contributor</SettingsRowTitle>
              <SettingsRowDescription>
                Create a copy of this contributor with all its settings.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
          ...
          <SettingsRow>
            <SettingsRowDetails>
              <SettingsRowTitle>Delete Contributor</SettingsRowTitle>
              <SettingsRowDescription>
                Permanently remove this contributor. This action cannot be undone.
              </SettingsRowDescription>
            </SettingsRowDetails>
            <SettingsRowAction>
